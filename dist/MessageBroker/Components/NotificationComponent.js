 ...
 */
let NotificationComponent = class NotificationComponent extends MessageDrivenComponent {
    /**
     * You can inject broker and (optionally) registry, or supply a custom filter.
     */
    constructor(broker, filterRegistry) {
...
NotificationComponent = __decorate([
    ...
    __param(1, inject(ContainerTypes.MessageFilterRegistry)),
    __param(1, optional()),
